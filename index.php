  ...
  <body>
    ...
    <main>
      <section class="principal" id="home" >
        ...
        <div class="scroll" data-menu="suave"><a href="#sobre" > <p> Role Para Baixo </p> <img src="./assets/scroll.png" alt="Setinha indicando para rolar a tela para baixo"></a></div>
      </section>
...
Meu objetivo é contribuir para projetos desafiadores e inovadores, onde eu possa aplicar minhas habilidades técnicas e minha experiência em suporte para desenvolver produtos que façam a diferença.
 Estou especialmente interessado em oportunidades que me permitam continuar aprendendo e crescendo, ao mesmo tempo em que agrego valor significativo à equipe e aos clientes.
          ...
          <a href="./assets/Romario-Alcantara.pdf" download="">
      ...
      <section class="experiencia" id="experiencia" data-anime="js-scroll">
        ...
        <div class="experiencia__wrapper">
          ...
          <section data-anime="show-right">
            <h2>Desenvolvedor Drupal</h2>
            <span>Fev 2024  </span>
            <p class="experiencia__descricao-local">IBDMAR </p>
            <p>
              Desenvolvi um site corporativo totalmente do zero utilizando o CMS Drupal, atendendo à demanda de um cliente que precisava de um website escalável, seguro e com funcionalidades personalizadas para gerenciar conteúdo de forma eficiente.</p>
          </section>
          <section data-anime="show-right">
          ...
          <section data-anime="show-right">
            <h2>Desenvolvedor WordPress</h2>
            <span>Nov 2024</span>
            <p class="experiencia__descricao-local">AppTour </p>
            <p>
              Desenvolvi uma landing page moderna e eficiente utilizando WordPress para atender às necessidades de um cliente que desejava capturar leads de maneira estratégica. O objetivo era criar uma página focada em conversões, com design atrativo, carregamento rápido e otimização para dispositivos móveis.</p>
          </section>  
        </div>
      </section>
...
<section class="projetos" id="projetos">
    <div class="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="./images/typ.png" alt="">
               
                
            </div>
            <div class="carousel-item">
                <img src="./images/drupal.png" alt="">
